...
The governed API is the durable source of truth for video editing and publishing. Publishing requires independent rights, consent, moderation, accessibility, and brand review. Provider credentials stay in a secrets manager and only references enter payloads. Generated backlog endpoints are disabled by default and cannot be enabled in production.

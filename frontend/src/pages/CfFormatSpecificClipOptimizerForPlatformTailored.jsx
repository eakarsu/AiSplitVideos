...
// Feature: Format-specific clip optimizer for platform-tailored exports
...
export default function CfFormatSpecificClipOptimizerForPlatformTailored() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-format-specific-clip-optimizer-for-platform-tailored-exports/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-format-specific-clip-optimizer-for-platform-tailored-exports', project: 'AiSplitVideos' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-format-specific-clip-optimizer-for-platform-tailored-exports/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Format-specific clip optimizer for platform-tailored exports</h1>
